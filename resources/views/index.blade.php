        ...
        <main>
            <section class="hero">
                <video autoplay muted loop>
                    <source
                        src="{{ asset('assets/videos/hero.mov') }}"
                        type="video/mp4"
                    />
                </video>
                ...
                <div class="container">
                    <div class="content-wrapper">
                        ...
                        <p data-aos="fade-up" data-aos-delay="1000" data-aos-duration="1500">
                            ...
                            uz ski stazu, Hotel Termag je idealna destinacija za
                            sve one koji uzivaju u zimskim sportovima. Hotel
                            nudi bogat sadržaj svojim posjetiocima a sve to uz
                            garantovanu udobnost i vrhunsku uslugu. Nas Wellnes
                            centar je prava oaza opuštanja i relaksacije a
                            gastronomska ponuda naseg restorana ce vas
                            oduševiti. Za poslovne dogadjaje, na raspolaganju su

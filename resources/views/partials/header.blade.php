...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link
            rel="stylesheet"
            href="{{ asset('assets/stylesheets/main.css?v=2.0.7') }}"
        />
        <link
        ...
        })(window,document,'script','dataLayer','GTM-NRBN7KL3');</script>
        <!-- End Google Tag Manager -->
    </head>
    <body>
        <!-- Google Tag Manager (noscript) -->
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NRBN7KL3"
            ...
            >
                ...
                <div class="offcanvas-body">
                    ...
                    <div>
                        ...
                        <a href="{{Helper::url('rezervacija')}}" type="button">{{__('Book now')}}</a>
                    </div>
                </div>
            </div>
        </div>

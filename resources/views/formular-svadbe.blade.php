...
<main>
    <section class="career">
        <div class="bg center" style="background-image: url('{{asset("assets/images/svadbe-bg.jpg")}}');"></div>
        <div class="container">
            <div class="content-wrapper">
                <h1 data-aos="fade-right" data-aos-duration="1500" data-aos-delay="250">{{__('Weddings')}}</h1>
        ...
        <div class="container">
            <div class="col-lg-12">
                <div class="cardd">
                    ...
                    <form action="{{url('formular-svadbe')}}" class="sned_file" method="POST" enctype="multipart/form-data">
                        @csrf

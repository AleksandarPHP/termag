@extends('layouts.app')
    @section('title', Helper::title(127))
    @section('description', Helper::description(127))
    @section('content')
<main>
    <section class="career">
        @php $text =  Helper::text(128) @endphp
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show @if ($loop->first) active @endif" id="nav-home{{$item->id}}" role="tabpanel" aria-labelledby="nav-home-tab{{$item->id}}" tabindex="0">
                        ...
                        <div class="text-center mt-5">
                            ...
                            <a href="{{Helper::url($package->url)}}" class="btnn btn_primary mt-4">{{__('Book now')}}</a>
                        </div>
                    </div>  
                    @endforeach
                </div>

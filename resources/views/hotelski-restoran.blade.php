@extends('layouts.app')
    @section('title', Helper::title(27))
    @section('description', Helper::description(27))
    @section('content')
<main>
    <section class="career">
        @php $text =  Helper::text(28) @endphp
    ...
    <section class="wellness-spa">
        @php $text =  Helper::text(29) @endphp
    ...
    <section class="villa-termag">
        @php $text =  Helper::text(30) @endphp
        <div class="bg center" style="background-image: url('{{asset("storage/".$text->image)}}');"></div>
        <div class="container">
            <div>
    ...
    <section class="wellness-spa">
        @php $text =  Helper::text(31) @endphp
        <div class="bg center" style="background-image: url('{{asset("storage/".$text->image)}}');"></div>
        <div class="container">
            <div class="cardd" data-aos="fade-left" data-aos-duration="600">
                @isset($text->title)
    ...
    <section class="villa-termag">
        @php $text =  Helper::text(32) @endphp
        <div class="bg center" style="background-image: url('{{asset("storage/".$text->image)}}');"></div>
        <div class="container">
            <div>

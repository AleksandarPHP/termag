    ...
    <div class="col-md-12">
        <form method="post" action="@if(!$editing) {{ url('cms/pages') }} @else {{ url('cms/pages/'.$item->id) }} @endif" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                @endif
                @if ($item->id==17 || $item->id==18 || $item->id==19 || $item->id==20 || $item->id==26 || $item->id==25 || $item->id==204 || $item->id==205 || $item->id==206 || $item->id==207  || $item->id==209 || $item->id==210 || $item->id==211 || $item->id==212 || $item->id==213 || $item->id==230 || $item->id==234  || $item->id==235  || $item->id==236 || $item->id==252)
                @for ($i = 2; $i <= 8; $i++)
                @php
                 $img = 'image'.$i;   
                @endphp
